...
A planned, updated Q2 2026 release (V2) will be rolled out to alternative platforms outside of the big music streaming platform ecosystem. Candidate platforms for release include:

* [Subvert](https://subvert.fm/)
* [Metalabel](https://metalabel.com)
* [Even](https://get.even.biz/)
* [Nina](https://www.ninaprotocol.com/explore)

A dedicated web app built from this repository is currently planned for, which will house all current and future versions of the project, and a user-friendly interface for audience to interact with aspects of the production.
...
- July 2025 - Alpha on [untitled] - mix drafts, arrangements, pre-production - (private) 
- October 15, 2025 - Beta/V0 - mixed by GT, unmastered (private)
- October 16, 2025 - Gamma/V1 - mastered by Dume41 (public-limited)
